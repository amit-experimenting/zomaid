...
| docs/specs/2026-05-16-diet-preferences-design.md | household.md, recipes.md | per-member diet preference + recipe diet classification + strictest-non-maid aggregation |
...
| docs/specs/2026-05-16-loaders-and-transitions-design.md | infrastructure.md | per-route `loading.tsx` skeletons + `PendingButton` wrapper — cross-cutting UX infra |
